  ...
  init() {
    ...
    for (const element of sliderElements) {
      try {
        ...
        // Find navigation buttons in the section-service structure
        const parentSection = element.closest('.section-service');
        const prevButton = parentSection?.querySelector('.section-service-frame3');
        const nextButton = parentSection?.querySelector('.section-service-frame4');
        ...
        // Add manual event listeners for navigation buttons since they are icons
        if (prevButton) {
          prevButton.style.cursor = 'pointer';
          prevButton.setAttribute('role', 'button');
          prevButton.setAttribute('aria-label', 'Vorherige Karte');
        ...
        if (nextButton) {
          ...
          nextButton.setAttribute('aria-label', 'Nächste Karte');
